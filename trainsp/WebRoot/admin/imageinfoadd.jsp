...
<BODY>
<form action="/trainsp/sys.do?action=addimageinfo" name="f1" method="post" onsubmit="return check()"  enctype="multipart/form-data">
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" >
  ...
  <TR>
   ...
   类型:<select id="type" name="type">
    ...
    <TD bgcolor="#FFFFFF" class="STYLE19" width="80%" height=24><input name="txt2" type="file" id="txt2"></TD></TR>
  <TR>
    <TD  height=24 align="center" bgcolor="#FFFFFF" class="STYLE19">图片三</TD>
    <TD bgcolor="#FFFFFF" class="STYLE19" width="80%" height=24><input name="txt3" type="file" id="txt3"></TD></TR>
     <TR>
    <TD  height=24 align="center" bgcolor="#FFFFFF" class="STYLE19">图片四</TD>
    <TD bgcolor="#FFFFFF" class="STYLE19" width="80%" height=24><input name="txt4" type="file" id="txt4"></TD></TR>
     <TR>
    <TD  height=24 align="center" bgcolor="#FFFFFF" class="STYLE19">图片五</TD>
    <TD bgcolor="#FFFFFF" class="STYLE19" width="80%" height=24><input name="txt5" type="file" id="txt5"></TD></TR>
  <TR>
    <TR>
