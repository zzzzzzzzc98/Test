...
<link href="/trainsp/images/skin.css" rel="stylesheet" type="text/css" />
  ...
  <body>
   <%
String url="/trainsp/admin/members.jsp?1=1";
...
sql+=" order by id desc ";
 %>
     <form action="/trainsp/admin/members.jsp?f=f" method="post" name="f1">
  ...
  <tr>
    ...
    <table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" class="left_txt">
      	<tr >
      		...
      		<td align="center" bgcolor="#f2f2f2">身份证</td>
      		<td align="center" bgcolor="#f2f2f2">电话</td>
      		<td align="center" bgcolor="#f2f2f2">邮箱</td>
      		<td align="center" bgcolor="#f2f2f2">注册日期</td>
  ...
  PageManager pageManager = PageManager.getPage(url,10, request);
   ...
   %>
        <tr bgcolor="#FFFFFF">
      		...
      		<td align="center"><%=map.get("email") %></td>
      		<td align="center"><%=map.get("savetime") %></td>
      		<td align="center">
      		<a href="/trainsp/admin/members.jsp?did=<%=map.get("id") %>">删除</a></td>
      	</tr>
      	<%} %>
...
<script type="text/javascript">
  function add()
  {
  pop("/trainsp/admin/sysuseradd.jsp","新增",500,160);
  }
  
  function up(no)
  {
  pop("/trainsp/admin/sysuserup.jsp?id="+no,"修改",500,160);
  }
  </script>
