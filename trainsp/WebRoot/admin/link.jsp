...
<link href="/trainsp/images/skin.css" rel="stylesheet" type="text/css" />
  ...
  <body>
   <%
String url="/trainsp/admin/link.jsp?1=1";
...
sql+=" order by id desc ";
 %>
     <form action="/trainsp/admin/link.jsp?f=f" method="post" name="f1">
  ...
  <tr>
    ...
    <table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" class="left_txt">
      	<tr >
      		<td align="center" bgcolor="#f2f2f2">链接名称</td>
      		<td align="center" bgcolor="#f2f2f2">链接地址</td>
  ...
  if(did!=null)
  {
  dao.commOper("delete from link where  id="+did);
  }
  PageManager pageManager = PageManager.getPage(url,10, request);
   ...
   %>
        <tr bgcolor="#FFFFFF">
      		...
      		<td align="center"><%=map.get("url") %></td>
      		<td align="center"><a href="javascript:up(<%=map.get("id") %>)">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
      		<a href="/trainsp/admin/link.jsp?did=<%=map.get("id") %>">删除</a></td>
      	</tr>
      	<%} %>
...
<script type="text/javascript">
  function add()
  {
  location.href("linkadd.jsp");
  }
  
  function up(no)
  {
  location.href("linkup.jsp?id="+no);
  }
  </script>
