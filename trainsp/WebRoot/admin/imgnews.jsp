...
<link href="/trainsp/images/skin.css" rel="stylesheet" type="text/css" />
  ...
  <body>
   <%
String url="/trainsp/admin/imgnews.jsp?1=1";
String key = request.getParameter("key")==null?"":request.getParameter("key");
String sql = "select * from news where 1=1 and type=1";
if(!key.equals(""))
{
url+="&key="+key;
...
sql+=" order by id desc ";
 %>
     <form action="/trainsp/admin/imgnews.jsp?f=f" method="post" name="f1" enctype="multipart/form-data" >
  ...
  <tr>
    ...
    <td valign="top" background="/trainsp/images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">图片资讯</div></td>
      </tr>
    </table></td>
  ...
  <tr>
    ...
    <table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" class="left_txt">
      	<tr >
      		...
      		<td align="center" bgcolor="#f2f2f2">图片</td>
  ...
  PageManager pageManager = PageManager.getPage(url,10, request);
   ...
   %>
        <tr bgcolor="#FFFFFF">
      		...
      		<td align="center"><img src="../upfile/<%=map.get("img") %>" width="100" height="60" /></td>
      		<td align="center"><%=map.get("savetime") %></td>
      		<td align="center"><a href="javascript:up(<%=map.get("id") %>)">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
      		<a href="/trainsp/admin/imgnews.jsp?did=<%=map.get("id") %>">删除</a></td>
      	</tr>
      	<%} %>
...
<script type="text/javascript">
  function add()
  {
  location.href("imgnewsadd.jsp");
  }
  
  function up(no)
  {
  location.href("imgnewsup.jsp?id="+no);
  }
  </script>
