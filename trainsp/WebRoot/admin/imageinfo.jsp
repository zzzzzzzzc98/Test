...
<link href="/trainsp/images/skin.css" rel="stylesheet" type="text/css" />
  ...
  <body>
   <%
String url="/trainsp/admin/imageinfo.jsp?1=1";
...
String sql = "select * from imageinfo where 1=1  ";
if(!key.equals(""))
{
url+="&key="+key;
...
sql+=" order by id desc ";
 %>
     <form action="/trainsp/admin/imageinfo.jsp?f=f" method="post" name="f1">
  ...
  <tr>
    ...
    <td valign="top" background="/trainsp/images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt">图片信息</div></td>
      </tr>
    </table></td>
...
<script type="text/javascript" src="/trainsp/commfiles/js/calendar/WdatePicker.js"></script>&nbsp;
  ...
  <tr>
    ...
    <table width="98%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" class="left_txt">
      	<tr >
      		<td align="center" bgcolor="#f2f2f2">ID</td>
      		<td align="center" bgcolor="#f2f2f2">类型</td>
      		<td align="center" bgcolor="#f2f2f2">标题</td>
      		<td align="center" bgcolor="#f2f2f2">内容摘要</td>
      		<td align="center" bgcolor="#f2f2f2">作者</td>
      		<td align="center" bgcolor="#f2f2f2">发布日期</td>
  ...
  if(did!=null)
  {
  dao.commOper("delete from  imageinfo  where id="+did);
  }
  PageManager pageManager = PageManager.getPage(url,10, request);
   ...
   %>
        <tr bgcolor="#FFFFFF">
      		...
      		<td align="center">
      		<%String nr = map.get("content").toString();
      		if(nr.length()>20){
      		...
      		<a href="/trainsp/admin/imageinfo.jsp?did=<%=map.get("id") %>">删除</a></td>
      	</tr>
      	<%} %>
...
<script type="text/javascript">
  function add()
  {
  pop("/trainsp/admin/imageinfoadd.jsp","新增",800,500);
  }
  
  function up(no)
  {
  pop("/trainsp/admin/imageinfoup.jsp?id="+no,"修改",800,500);
  }
  </script>
